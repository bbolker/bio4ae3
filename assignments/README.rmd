...
## Discussion questions/Perusall (Part of 15% participation mark)
...
Pick **three recent** related papers about a parasite/ID eco/evo topic of your choice.

* the topic doesn't have to be something we've covered in class, but it must be eco/evo-related, not just about ID generally [e.g. topics that are entirely about immunology, or pharmacology, or public health, would not count] 
* it can be related to your term paper topic if you like
* "recent" is a little bit flexible: ideally your papers would be newer that 2020, if necessary you can go back as far as 2015. In any case, though, they should be some of the newer papers in the particular field you're covering.

Write a 1-2 page (single-spaced) paper that describes the topic and **synthesizes** the results of the papers. You should make sure that your paper is *not* of the form "paper A says ...; paper B says ...; paper C says ...". What points do the papers make, and what kind(s) of data do they present to support their points? How are the papers related? Do they agree or disagree? Do they build on each other, or discuss different aspects of the same topic, or tackle the topic at different levels (e.g. models, lab experiments, field experiments)?

Please **do not** use AI (large language models) for this mini-essay. I reserve the write to run your paper through AI checking software, and to have a conversation with you about the topic of your mini-essay if I am suspicious (I will not take the results of any AI checker at face value).

### Mini-essay 3

Use two different publicly available large language models (e.g. choose from Claude, Microsoft Copilot [via McMaster], ChatGPT ...) to re-do mini-assignment essay 2. Discuss the difference between your synthesis and those of the two LLMs. Did the LLMs make any mistakes? Do you think you would have gotten an equally good understanding of the results of the papers by running the LLMs instead of doing it yourself, or a nearly equally good understanding with much less effort? (Please be honest.)

It may be a good idea to use a series of prompts to refine the answers that the LMMs give you. After your (1-2 page) discussion of the differences between your synthesis and the LLM syntheses, include the prompts you used and the final outputs of the LLMs as appendices/additional pages.
...
- a paragraph or two laying out your topic, and giving three references, is due on October 3 (1 month into the term), at the end of the day.
- your first draft is due on November 7, one month later. **This should be a finished paper representing your best effort**: the better the  draft, the better feedback you will get from your peers/the TA/me. 
- you will have one week to comment on one of your peers' papers
...
- evolution and management of antibiotic-resistant tuberculosis
...
You will take the midterm in the evening (6-8 PM), on either Oct 8 or Oct 9. The midterm is designed for one hour, but you'll have a two-hour time slot.

You should know a variety of examples so that you can use them in your short answers and essays.

- [midterm from a previous iteration of this course](./midterm_fall2023.pdf)
- [essay topics](./midterm-topics.html)

## Final (25%)

This have a similar format to the midterm; it will focus on post-midterm material but may include material from any time during the term.
