...
- Parasites evolve lower virulence over time "for the good of the species".  Group-selectionist *but* some evidence? [@methotWhyParasitesHarm]
...
- Intermediate virulence evolves due to *host-level* selection (group theory returns); a tradeoff between transmission *rate* (infections/host/time) and virulence (*defined as mortality/time*) maximizes $R_0$ (total transmission per generation) at **intermediate** virulence.
...
* successive waves tended to have higher ${\cal R}_0$
* higher ${\cal R}_0$ partly from *immune evasion*; re-infection of individuals recovered from/immune to previous strains
* virulence changes: alpha, delta higher, omega lower (reduced "fusogenicity" [ability to fuse with/enter host cells]; tropism for cells higher in respiratory tract? [@carabelliSARSCoV2VariantBiology2023]
...
- evolution of higher virulence in unvaccinated people due to "leaky" vaccination [@Gandon+2001]?
