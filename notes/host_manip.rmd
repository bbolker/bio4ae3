...
High fecundity helps parasites ensure their transmission from one host
to another. However, they can also improve the
probability of transmission for each offspring by investing resources in
quality, rather than quantity. How?
...
- Studies dissecting mechanisms leading to behavioral change. For
...
@liGeneExpressionAssociated2025 do **transcriptomic** analysis of *Dicrocoelium dendriticum* across phases of behavioural modification.
