...
* *Diplostomum phoxini* (Ballabeni, *Functional ecology* **9**, 887-893) generates gigantism only in local (adapted) host populations (this rules out coincidental changes but doesn't necessarily settle the question of host vs parasite adaptation).
