...
- mechanisms of action:
	...
	- altered molecular conformulation (@finkenMolecularBasisStreptomycin1993: "... resistance against multiple unrelated drugs in *M. tuberculosis* is not caused by a single event involving resistance to a panel of antibiotics, e.g. an altered permeability barrier, but rather conferred by an accumulation of multiple mutational events specific for each drug's target respectively as demonstrated for streptomycin")
