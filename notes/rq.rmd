...
-   "Kondrashov's hatchet" (an analogue that works in large populations,
with epistasis); natural selection is *more* effective at purging
deleterious mutations. Also see Keightley & Otto (2006) on mutation
purging.
...
Snails and trematodes {#snails-and-trematodes .unnumbered}
---------------------
...
Lively et al's experiments and observations {#lively-et-als-experiments-and-observations .unnumbered}
===========================================
...
Potential problems for the Red Queen {#potential-problems-for-the-red-queen .unnumbered}
====================================
