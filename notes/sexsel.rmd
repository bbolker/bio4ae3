...
as important, since H-Z works with a \emph{conditional} trait
\end{itemize}
\end{itemize}
...
\emph{lower} levels in showy species?
\end{itemize}
...
Why is testoterone immunosuppressive?
...
the mating season must have good genes ...

Good links between androgens and secondary sex characteristics.
Some support for the link between testosterone
(and other androgens) and immunosuppression, 
but high variable results in different experiments.
Immunoredistribution rather than immunosuppression?

Other axes of signalling and immune function:
carotenoid, melanin, androgen (testosterone) systems.
