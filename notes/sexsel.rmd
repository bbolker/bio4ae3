...
Honest signaling says that traits are not chosen despite their being costly, but
*because* they are costly.  **Good genes** model.  Ornaments are a signal of good genes:
...
- viability ("Zahavi") traits: expressed by everyone, but penalizes low-quality males (signaling costs must be higher for low-quality males, or high-quality males must gain more from mating)
...
Problem with traits as honest signals: what maintains genetic variation for
