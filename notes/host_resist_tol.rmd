...
- passive/always-on defense (*constitutive* defenses)	
    - changing cell surface receptors (e.g. CCR5-Δ32 (HIV, @hummel_detection_2005); matching-allele model
...
![](schaffner_positiveselection-f1_mid_1.jpg)
...
- at least 5000 years old; @hummel_detection_2005; @novembre_geographic_2005; @galvani_evolutionary_2005; @liden_pushing_2006
   - "If Δ32 were neutral, population genetics theory predicts it would have to be much older given its frequency."
