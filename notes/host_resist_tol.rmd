...
- cost of mounting a response (including immunopathology)
...
- resistance lowers prevalence &mdash; selects against itself; expect *polymorphism*
- tolerance increases prevalence &mdash; selects for itself (*apparent competition* with non-tolerant genotypes); expect *fixation*. (Is tolerance evolution-proof? [@schneider_two_2008])
...
* Tb resistance? [@boschCysticFibrosisCarriership2017; @meindlHypothesisSelectiveAdvantage1987; @poolmanEvaluatingCandidateAgents2006]
...
* evidence
   * ancient DNA
   * phylogenetic patterns/*coalescent* methods to estimate origin times/places (and population size over time: *skyline plot*)
       * see [notes](coalescent.html) on how coalescent estimation works
...
GWAS study of COVID-19 finds some relevant loci (but not *evolutionarily* relevant?)
