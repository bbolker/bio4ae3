...
```{r spoiler_par, echo = FALSE}
spoilers <- as.logical(Sys.getenv("SHOW_SPOILERS", unset = "FALSE"))
```
...
```{r paras_burden_Q, echo = FALSE, results="asis"}
if (!spoilers) cat("**your answers here\n**") else cat("
- case reports
...
<!-- ::::: {#special .spoiler tabindex="0"} -->
```{r evolution_obs, echo = FALSE, results="asis"}
if (!spoilers) cat("**your answers here\n**") else cat("
