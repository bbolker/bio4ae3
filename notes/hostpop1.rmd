...
before their hosts do (due to a *density threshold*), so parasites should not be
...
(So-called "virgin soil" epidemics [@crosby_virgin_1976; @diamond_guns_2005])
...
active area of research. (**Update** in @stokholmEmergenceRadiationDistemper2021: population sizes may have been too small to allow this? But this may be a mistake ... @klepacStagestructuredTransmissionPhocine2009 say $R_0$ is only $\approx 2.2$ -- what is the critical community size in this case?)
...
![](pix/wsb_newmexico.png)

[@swetnamMulticenturyRegionalScalePatterns1993]

The cycles are very clear (typically 8--11 years [but longer for western spruce budworm], often highly synchronized across
